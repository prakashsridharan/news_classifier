...
df = pd.read_csv('data/news_datafame.csv')
df.info()
...
joblib.dump(vectorizer1, (data_path + "/model_files" + '/vectorizer_news_text.pkl'))
joblib.dump(vectorizer2, (data_path + "/model_files" + '/vectorizer_link.pkl'))
joblib.dump(vectorizer3, (data_path + "/model_files" + '/vectorizer_authors.pkl'))
...
def run_model(model_name, est_c, est_pnlty):
    ...
    joblib.dump(oneVsRest, (data_path + "/model_files/" + filename))
